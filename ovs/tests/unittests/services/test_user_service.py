...
class TestUserService(OVSBaseTestCase):
    ...
    def test_edit_user_bad_id(self):
        ...
        self.assertFalse(UserService.edit_user(self.test_user.id+3, 'test_edit@gmail.com', 'John', 'Smith')) #random id
        self.assertIsNone(UserService.get_user_by_email('test_edit@gmail.com').first())
